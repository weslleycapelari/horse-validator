...
- Source file: `src/Horse.Validator.Rule.DateEquals.pas`
...
THorseValidator.New(Req)
  .Field('body.value')
  .AddRule(TRules.DateEquals(EncodeDate(2026, 3, 16)))
  .Validate;
```
...
THorseValidator.New(Req)
  .Field('body.value')
  .AddRule(TRules.DateEquals('referenceField'))
  .Validate;
```
...
THorseValidator.New(Req)
  ...
  .Field('body.value').AddRule(TRules.DateEquals(EncodeDate(2026, 3, 16)).SetMessage('DateEquals validation failed for this field.'))
  .Validate;
```
...
```json
{
  ...
  "validations": {
    "body.value": [
      "The field body.value failed the DateEquals rule."
    ]
  }
}
```
