...
- Source file: `src/Horse.Validator.Rule.uString.pas`
...
THorseValidator.New(Req)
  ...
  .Field('body.value').AddRule(TRules.String().SetMessage('String validation failed for this field.'))
  .Validate;
```
...
```json
{
  ...
  "validations": {
    "body.value": [
      "The field body.value failed the String rule."
    ]
  }
}
```
